...
/**
 * Sets a header attribute on a header object, as an object.  If that header was
 * previously set, this will replace the previous value with the new one.
 *
 ...
 * \returns an object containing the current value for the requested attribute. It is
 * valid as long as the corresponding cjose_header_t object is not released.
 */
