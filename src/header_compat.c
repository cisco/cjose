 ...
 * Copyright (c) 2014-2026 Cisco Systems, Inc.  All Rights Reserved.
 */

/* Historical public data symbols kept for ABI compatibility. New consumers
 * get string-literal macros from the public header instead.
 *
 * TODO: Remove this file when version 1.0.x cycle begins */
